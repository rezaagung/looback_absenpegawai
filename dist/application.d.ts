...
declare const LoobackAbsenpegawaiApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class LoobackAbsenpegawaiApplication extends LoobackAbsenpegawaiApplication_base {
